...
console.log (`${typeof numberFloat}, ${notNumber}, ${number1}, ${typeof number}`);

//Fourth exercise 

let someInformation ='Wikipedia is a free online encyclopedia, created and edited by volunteers around the world and hosted by the Wikipedia Foundation'; 
